...
В функции `gradient_descent_2` предствлено градиентный спук
```
...
```
### Вывод 
Научился находить локальный минимум при помоши </u>градиентного спуска</u>
...
Целью работы являеться изучение принципа алгоритма случайных блужданий и применить его для решения задачи о разорении игрока.
...
Целью работы являеться изучение рассчета определенного интеграла заданной функции на интервале методами :
...
Представленны в функциях `left_rectandles` и `right_rectandles`
```
def left_rectandles():
...
Представленны в функции `trapezoid`
``` 
def trapezoid():
...
Представленны в функции `monte_carlo`
...
Представленны в функции `simpsons`
``` 
def simpsons():
...
Целью работы являеться изучение и применения метода бисекций и метода хорд для решения уравнения  
